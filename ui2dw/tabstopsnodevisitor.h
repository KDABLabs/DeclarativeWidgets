...
#ifndef TABSTOPSNODEVISITOR_H
#define TABSTOPSNODEVISITOR_H

#include "uinodevisitor.h"

class TabStopsNodeVisitor : public UiNodeVisitor
{
  public:
    explicit TabStopsNodeVisitor(const SharedVisitationContext &sharedContext);
  ...
  private:
    ...
    QSet<UiNode*> m_tabStopsNodes;
};

#endif // TABSTOPSNODEVISITOR_H
